...
final class NeutralOutput
{
   ...
   NeutralOutput(PrintWriter output) { this.output = output; }

   boolean writeLineWithoutCoverageInfo(LineParser lineParser)
   {
   ...
   private void extractLineIndentation(String lineText)
   {
   ...
   private boolean writeLineInImports(LineParser lineParser)
   {
      LineElement initialElement = lineParser.getInitialElement();
