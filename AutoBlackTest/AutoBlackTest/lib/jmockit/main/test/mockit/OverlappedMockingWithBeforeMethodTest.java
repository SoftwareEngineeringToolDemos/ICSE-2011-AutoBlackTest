...
public final class OverlappedMockingWithBeforeMethodTest
{
   ...
   @Before
   public void sharedMockingOfAnotherSubclass()
   {
      new NonStrictExpectations() { @Mocked("doStatic1") final BaseClass mock = null; };
   }
   ...
   public void overlappedStaticPartialMockingWithLocalMockFieldInsteadOfMockParameter()
   {
      ...
      new NonStrictExpectations() {
         @Mocked({"doStatic2", "doSomethingElse"}) DerivedClass mock;
