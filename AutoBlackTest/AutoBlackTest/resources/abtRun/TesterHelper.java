 ...
 * Generated     : <b>2013/01/09 6:37:27 AM</b><br>
...
public abstract class TesterHelper extends RationalTestScript
{
	...
	/**
	 * RegistroRiproduzionePerAbtRunTester: with default state.
	 *		.title : Registro riproduzione per abtRun.Tester
	 * 		.class : Html.HtmlDocument
	 * 		.url : file://C:\workspaceDist\AutoBlackTest_logs\abtRun.Tester\rational_ft_log.html
	 */
	protected DocumentTestObject document_registroRiproduzioneP() 
	{
		return new DocumentTestObject(
                        getMappedTestObject("document_registroRiproduzioneP"));
	}
	/**
	 * RegistroRiproduzionePerAbtRunTester: with specific test context and state.
	 *		.title : Registro riproduzione per abtRun.Tester
	 * 		.class : Html.HtmlDocument
	 * 		.url : file://C:\workspaceDist\AutoBlackTest_logs\abtRun.Tester\rational_ft_log.html
	 */
	protected DocumentTestObject document_registroRiproduzioneP(TestObject anchor, long flags) 
	{
		return new DocumentTestObject(
                        getMappedTestObject("document_registroRiproduzioneP"), anchor, flags);
	}
	...
	/**
	 * ModificaInserzione: with default state.
	 *		.captionText : Modifica Inserzione
	 * 		.class : de.shandschuh.jaolt.gui.EditAuctionJDialog
	 */
	protected TopLevelTestObject modificaInserzione() 
	{
		return new TopLevelTestObject(
                        getMappedTestObject("modificaInserzione"));
	}
	/**
	 * ModificaInserzione: with specific test context and state.
	 *		.captionText : Modifica Inserzione
	 * 		.class : de.shandschuh.jaolt.gui.EditAuctionJDialog
	 */
	protected TopLevelTestObject modificaInserzione(TestObject anchor, long flags) 
	{
		return new TopLevelTestObject(
                        getMappedTestObject("modificaInserzione"), anchor, flags);
	}
	...
	/**
	 * Regione: with default state.
	 *		uIClassID : TextFieldUI
	 * 		.class : javax.swing.JTextField
	 * 		.priorLabel : Regione
	 * 		.classIndex : 1
	 */
	protected TextGuiSubitemTestObject regione() 
	{
		return new TextGuiSubitemTestObject(
                        getMappedTestObject("regione"));
	}
	/**
	 * Regione: with specific test context and state.
	 *		uIClassID : TextFieldUI
	 * 		.class : javax.swing.JTextField
	 * 		.priorLabel : Regione
	 * 		.classIndex : 1
	 */
	protected TextGuiSubitemTestObject regione(TestObject anchor, long flags) 
	{
		return new TextGuiSubitemTestObject(
                        getMappedTestObject("regione"), anchor, flags);
	}
