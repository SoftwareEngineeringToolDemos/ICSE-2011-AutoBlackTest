				...
				for(String keyword : listKeywords){
					...
					if(key!=-1){
						...
						for(Integer secondIndex : keySet){
							...
							//controllo se è un dato segnalato come errato
...
//								//controllo se è già stato utilizzato
...
//							}else
			 ...
			 * esempio: textfield con label città contiene "milano"
			 * questa funzionalità estrae il testo "milano"
			 * Questa opzione è stata commentata perchè se il testo non è semanticamente corretto 
			...
			*/
			/*queta opzione estra le informazioni dalla proprietà tooltips, 
		...
		//se non è stato possibile associare nessuna informazione
