 ...
 */
public class TestExperimentByEpisode implements /*Runnable, */ Serializable
{
	 ...
	 */
	public TestExperimentByEpisode(Agent agent, TestEnvironment env, int maxEpisodes, int maxSteps)
	{
		this.env = env;
		this.agent = agent;
	...
	public TestExperimentByEpisode(Agent agent, TestEnvironment env)
	{
		this.env = env;
		this.agent = agent;
	}
	...
	public void run()
	{
		...
		for (int episode = 0; episode < maxEpisodes; episode++) {
			log4j.info("Starting episode " + (episode+1) + " of "
					+ maxEpisodes + " ...");
